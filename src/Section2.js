...
const useStyles = makeStyles(theme => ({
  section2: {
    height:'auto',
    minHeight:600,
    background:"#d1ffff url('/static/images/section2Bg.png') no-repeat top center",
    fontSize:20,
    display:'flex',
...
export default function Section2(){
  ...
  return (
    <Box bgcolor="#fafafa" height={600} px={4} className={classes.section2}>
      <Grid container className={classes.wrapper} spacing={8}>
